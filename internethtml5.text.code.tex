...
\cs_generate_variant:Nn \htmv_verb:n {V,N}
...
{
  \tl_gput_right:Nn \l__htmv_js_tl {#1}
}
...
{
  \exp_after:wN \htmv_marginpar_aux: \tex_let:D \l_peek_token =~
}
...
{
  \htmv_close_par:
  \htmv_open_tag:nn {table} {class="tabular"}
