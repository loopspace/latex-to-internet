...
\NewDocumentCommand \mmlwrap { O{mo} m}
{
  \mml_open_tag:nn {#1} {}
  #2
  \mml_close_tag:n {#1}
...
\cs_set_nopar:Npn \mml_xrightarrow:nn #1#2 {
  \bool_if:nTF
  {
    ! \tl_if_empty_p:n {#1}
    &&
  ...
  {
    \mml_open_tag:nn {munderover} {}
  }
  {
    \tl_if_empty:nF {#1}
    {
      \mml_open_tag:nn {munder} {}
    }
    \tl_if_empty:nF {#2}
    {
      \mml_open_tag:nn {mover} {}
    }
  }
  \mml_open_tag:nn {mo} {}
  \entity{rightarrow}
  ...
  }
  {
    ...
    \tl_if_empty:nF {#2}
    {
      ...
      \mml_close_tag:n {mover}
    }
  }
}
\NewDocumentCommand \xrightarrow { O{} m }
{
  \mml_xrightarrow:nn {#1}{#2}
}
...
\cs_set_nopar:Npn \emoji_text_char:n #1
{
  \bool_if:NTF \l__mml_maths_bool
  {
    \mml_open_tag:nn {mo} {}
