...
\cs_set:Npn \mkdn_num_section:nn #1#2
{
  ...
  \maru_enddiv:
  \txt_newline:
  \mkdn_section_header:nn {#1} {#2} \{: .num \tl_use:N \l__txt_underscore_tl \tl_use:N \l_tmpa_tl \}\par
}
...
{
  \tl_use:N \l__txt_underscore_tl #1 \l__txt_underscore_tl \{:~style="font-style:~ normal"\}
}
