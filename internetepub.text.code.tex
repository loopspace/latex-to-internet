...
{
  split at .code:n = {
    \xhtm_set_hook:nn {pre section header} {\epub_split_section:n {#1}}
  },
  split~ at .meta:n = {
    split at={#1}
  },
...
{
  \tl_new:N \l__epub_chapter_level_tl
  \tl_set:Nn \l__epub_chapter_level_tl {1}
...
\tl_set:Nx \l__epub_section_level_tl {\int_eval:n{\l_tmpa_int + 1}}
\tl_set:Nx \l__epub_subsection_level_tl {\int_eval:n{\l_tmpa_int + 2}}
\tl_set:Nx \l__epub_subsubsection_level_tl {\int_eval:n{\l_tmpa_int + 3}}
\tl_set:Nx \l__epub_paragraph_level_tl {\int_eval:n{\l_tmpa_int + 4}}
\tl_set:Nx \l__epub_subparagraph_level_tl {\int_eval:n{\l_tmpa_int + 5}}
...
\cs_new_nopar:Npn \epub_split_section:n #1
{
  \bool_if:nT {
    \int_compare_p:n {
      \seq_item:Nn \l__xhtm_args_seq {1} <= \tl_use:c             {l__epub_#1_level_tl}
    }
    &&
    \int_compare_p:n {
      \l__epub_curr_section_int >= \tl_use:c {l__epub_#1_level_tl}
    }
  }
  {
    \xhtm_close_par:
  ...
  \int_gset:Nn \l__epub_curr_section_int
  {
    \seq_item:Nn \l__xhtm_args_seq {1}
  }
}
