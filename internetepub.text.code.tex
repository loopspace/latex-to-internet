...
\xhtm_at_enddocument:n
{
  ...
  {
    \xhtm_linebreak:
    \xhtm_open_tag:nn {dc:creator} {id="title"}
    \@author
...
\AtBeginDocument{
  \cs_set:Npn \@setref #1#2#3
  {
    ...
    {
      \tl_set:Nn \l__xhtm_baseurl_tl {\jobname \exp_args:No \use_ii:nnnnn #1 .xhtml}
      \exp_args:No \Hy@setref@link #1 \@empty \@empty \@nil {#2}
    }
  }
}
...
{
  \tl_set:Nn \l__xhtm_baseurl {\jobname #3.xhtml}
