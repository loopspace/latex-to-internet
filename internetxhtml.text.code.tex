...
\tl_set:Nn \l__xhtm_begindisplay_tl
{
  ...
  {
    \xhtm_open_tag:nn {div} {class="displaymaths"~ id="\tl_use:N \l__xhtm_nextid_tl"}
    \tl_gclear:N \l__xhtm_nextid_tl
  }
...
\tl_set:Nn \l__xhtm_beginalign_tl
{
  \tl_set:Nn \l__xhtm_begindisplay_tl
  {
    \xhtm_close_par:
    \xhtm_linebreak:
    \xhtm_open_tag:nn {table} {class="align"}
    \xhtm_open_tag:nn {tr} {}
    \xhtm_open_tag:nn {td} {class="label"}
    \xhtm_close_tag:n {td}
    \xhtm_open_tag:nn {td} {class="maths"}
    \xhtm_open_tag:nn {div} {class="displaymaths~ align"}
    \tl_gclear:N \l__xhtm_eqnnums_tl
    \tl_gset:Nn \l__xhtm_eqnnums_tl
    {
  ...
  \bool_if:NT \l__itex_numbered_bool
  {
    ...
    \cs_set:Npn \itexnl
    {
      \tl_if_empty:NF \l__xhtm_nextid_tl
      {
        ...
        {
          \exp_not:N \xhtm_open_tag:nn {tr} {class="alignnumber_row"}
          \exp_not:N \xhtm_open_tag:nn {td} {}
          \bool_if:NT \l__xhtm_next_num_bool
          {
            \exp_not:N \xhtm_open_tag:nn {span} {class="alignnumber"~ id="\tl_use:N \l__xhtm_nextid_tl"}
            \theequation
...
\tl_new:N \l__xhtm_endalign_tl
\tl_set:Nn \l__xhtm_endalign_tl
{
  \bool_if:NT \l__itex_numbered_bool
  {
    \tl_gput_right:Nx \l__xhtm_eqnnums_tl
    {
      ...
      \exp_not:N \xhtm_close_tag:n {tr}
      \exp_not:N \xhtm_linebreak:
      \exp_not:N \xhtm_close_tag:n {table}
    }
    \tl_gclear:N \l__xhtm_nextid_tl
  }
}

\tl_new:N \l__xhtm_postendalign_tl
\tl_set:Nn \l__xhtm_postendalign_tl
{
  \xhtm_close_par:
  \xhtm_close_tag:n {td}
  \xhtm_open_tag:nn {td} {class="label"}
...
\txt_addto_hook:nnn {itex} {pre begin align} {\tl_use:N \l__xhtm_beginalign_tl}
\txt_addto_hook:nnn {itex} {pre end align} {\tl_use:N \l__xhtm_endalign_tl}
\txt_addto_hook:nnn {itex} {post end align} {\tl_use:N \l__xhtm_postendalign_tl}
