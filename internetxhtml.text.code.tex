...
\cs_new_nopar:Npn \xhtm_tocline:nnn #1#2#3
{
  ...
  \item #2
  \int_set:Nn \l__xhtm_toclvl_int {#1}
}
...
{
  \tl_put_right:Nn \l__xhtm_css_tl {#1}
}

\NewDocumentCommand \addjavascript {+m}
{
  \tl_put_right:Nn \l__xhtm_js_tl {#1}
}

\NewDocumentCommand \loadcss {m}
{
  \tl_put_right:Nn \l__xhtm_cssfiles_tl
  {
...
{
  \tl_put_right:Nn \l__xhtm_jsfiles_tl
  {
