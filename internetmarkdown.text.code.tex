...
\tl_new:N \l__mkdn_verbpre_tl
\tl_new:N \l__mkdn_verbpost_tl

\tl_set:Nn \l__mkdn_verbpre_tl {\mkdn_indent_by:n {4}}

\cs_set:Npn \verbatim
{
  \vskip\parskip
  \group_begin:
  \tl_use:N \l__mkdn_verbpre_tl
